  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center gap-2 md:justify-start">
          <a href="#" className="flex items-center gap-2 font-medium">
            <Image src="/PayHub_Logo.png" alt="PayHub" width={150} height={150} />
          </a>
        </div>
        ...
        <div className="flex justify-center gap-2 text-sm text-muted-foreground/80">
          <div>
            <p>Todos os direitos reservados © 2025 ArcturoTech</p>
          </div>
          <div>
      ...
      <div className="relative hidden lg:block overflow-hidden bg-background">
        ...
        >
          <source src="/video/Background_Image.mp4" type="video/mp4" />
        </video>
